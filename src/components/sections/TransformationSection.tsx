      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col gap-5 md:gap-7 max-w-3xl mx-auto">
            <div className="flex items-start bg-gray-800/60 p-5 rounded-md shadow-sm transition-shadow hover:shadow-md border-l-4 border-yellow-500">
              ...
              <div className="text-base md:text-lg space-y-2">
                <p>Tu te réveilles le matin avec <strong>l'esprit clair</strong>.</p>
            ...
            <div className="flex items-start bg-gray-800/60 p-5 rounded-md shadow-sm transition-shadow hover:shadow-md border-l-4 border-yellow-500">
              ...
              <div className="text-base md:text-lg space-y-2">
                <p>L'alcool ne te manque plus.<br/>Non pas par effort, mais parce que l'idée même te semble <strong>étrange, sans intérêt</strong>.</p>
                <p>Tu ressens une <strong>confiance sereine</strong>, une <strong>joie tranquille</strong> d'être simplement toi.</p>
                <p className="italic text-sm text-gray-300/80 mt-2">(<em>Et oui, ta santé et tes finances te remercient aussi !</em>)</p>
              </div>
            </div>
            ...
            <div className="flex items-start bg-gray-800/60 p-5 rounded-md shadow-sm transition-shadow hover:shadow-md border-l-4 border-yellow-500">
              ...
              <div className="text-base md:text-lg space-y-2">
                ...
                <p>Tu as <strong>retrouvé tes propres ressources intérieures.</strong></p>
              </div>
            </div>
          ...
          <div className="text-base md:text-lg text-center py-6 px-6 bg-gray-800/70 border border-yellow-500/30 rounded-lg space-y-2 mt-10 md:mt-14 text-gray-200 max-w-3xl mx-auto">
            <p>Ta vie <strong>n'est</strong> pas devenue parfaite (la vie est la vie !).</p>
            <p>Mais <strong>ta relation à toi-même</strong> s'est apaisée. Elle est <strong>vivante. Claire. Honnête.</strong></p>
            <p>Et elle <strong>t'appartient enfin, totalement.</strong></p>
          </div>
