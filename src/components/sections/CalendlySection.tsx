...
export function CalendlySection() {
  ...
  return (
    <section 
      id="calendly" 
      className="bg-sable-introspection py-20 md:py-28 mobile-padding"
    >
      <div className="container mx-auto">
        <div className="calendly__content max-w-3xl mx-auto text-center">
          ...
          <div className="calendly__intro text-base md:text-lg text-gris-sagesse mb-10 max-w-3xl mx-auto space-y-4 text-left">
            ...
            <p>Ce premier appel, c'est notre <strong>"état des lieux"</strong>.</p>
            <p>C'est un temps de parole d'environ une heure, <strong>100% confidentiel et sans aucun engagement</strong>,
            où on regarde ensemble où tu en es, ce que tu traverses, ce qui bloque.</p>
            <p>Tu poses ce que tu as à poser.
            Je t'écoute. Vraiment. Et je te dis en toute honnêteté si je pense pouvoir t'aider avec mon approche.</p>
          </div>
          ...
          <div className="text-base md:text-lg text-noir-profond mb-10 max-w-3xl mx-auto space-y-4 text-left font-semibold bg-yellow-400/10 p-6 rounded-lg border border-yellow-400/50">
            <p>J'accompagne <strong>un petit nombre de personnes à la fois</strong> pour garantir une vraie disponibilité et un suivi de qualité.</p>
            <p>Je travaille avec des gens <strong>prêts à s'engager</strong> dans leur compréhension et leur transformation.</p>
          </div>
          
          <div id="cta-highlight-zone" className="text-base md:text-lg text-gris-sagesse mb-12 max-w-3xl mx-auto space-y-2 text-left">
            <p>👉 Si tu sens que c'est <strong>ton moment</strong>,</p>
            <p>👉 si tu veux une <strong>écoute honnête et sans jugement</strong>,</p>
            <p>👉 <strong>prends ce temps. Il est pour toi.</strong></p>
          </div>
          ...
          <div className={`mb-16 relative ${ctaHighlighted ? 'animate-fadeScale' : ''}`}>
            ...
            <p className="mt-4 text-xs text-gris-sagesse/80 italic">Entretien confidentiel de 60 minutes - Places limitées</p>
          </div>
          ...
          <div className="mt-16 border border-gray-200 rounded-lg shadow-lg overflow-hidden">
            ...
            >
              ...
              {isClient ? null : <div className="bg-gray-100 flex items-center justify-center" style={{minWidth: "320px", height: "700px"}}>Chargement...</div>} 
            </div>
          </div>
        </div>
      </div>
